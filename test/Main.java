...
public class Main {
    ...
    public static void testRDinamico(ListRecursosDinamico listaRDinamica) {
        ...
        System.out.println("Resultado de getUsuarisDataAt(recurs)(deberia ser vacio al eliminar): "+listaRDinamica.getUsuarisDataAt(recurs,data));
    ...
    public static void testREstatico(ListRecursosEstatico listaREstatica) {
        ...
        System.out.println("Resultado de getUsuarisDataAt(recurs)(deberia ser vacio al eliminar): "+listaREstatica.getUsuarisDataAt(recurs,data));
